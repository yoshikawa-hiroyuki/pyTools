...
if rdType == 1:
    ...
    ofp.write(struct.pack('i3qi', 24, dims[0], dims[1], dims[2], 24))

# write org
if rdType == 1:
    ofp.write(struct.pack('i3fi', 12, org[0], org[1], org[2], 12))
else:
    ofp.write(struct.pack('i3di', 24, org[0], org[1], org[2], 24))

# write pitch
if rdType == 1:
    ofp.write(struct.pack('i3fi', 12, pitch[0], pitch[1], pitch[2], 12))
else:
    ofp.write(struct.pack('i3di', 24, pitch[0], pitch[1], pitch[2], 24))
